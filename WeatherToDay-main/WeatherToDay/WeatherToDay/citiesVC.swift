...
//  WeatherToDay
//
//  Created by Канавичев Алексей Александрович on 6/2/2023.
//
...
class citiesVC: UITableViewController {
    ...
    func currentWeather(city: String){
        ...
        let url = "https://api.weatherapi.com/v1/current.json?key=4dce682a15e3434087891311230602&q=Moscow&aqi=no"
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "weatherCell", for: indexPath) as! citiesNameCell
